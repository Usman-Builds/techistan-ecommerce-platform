...
-- CreateTable
CREATE TABLE "AutomaticDiscount" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "rule" JSONB NOT NULL,
    ...
    CONSTRAINT "AutomaticDiscount_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "StoreSetting" (
    ...
    "name" TEXT NOT NULL DEFAULT 'ShopForge',
    "logoPublicId" TEXT,
    "contactEmail" TEXT,
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "taxRules" JSONB,
...
-- CreateIndex
CREATE INDEX "AutomaticDiscount_status_idx" ON "AutomaticDiscount"("status");
...
-- CreateIndex
CREATE UNIQUE INDEX "StoreSetting_singleton_key" ON "StoreSetting"("singleton");
