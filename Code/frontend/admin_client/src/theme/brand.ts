// ─────────────────────────────────────────────────────────────────────────────
// Techistan BRAND — source of truth for the ADMIN CONSOLE (admin_client).
//
...
// three.
//
// After editing, run `npm run gen:theme` to re-emit src/theme/generated/
// theme.css — it runs automatically on `predev`/`prebuild`, so a normal
// `npm run dev` / `npm run build` already picks the change up.
//
